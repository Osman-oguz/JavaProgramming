package day31_Constructors.Offer;
 ...
 */
        ...
        fullTimeOffers.removeIf(p-> !p.isFullTime);  // removes the offer is NOT ful time

        System.out.println(fullTimeOffers.size());

        ArrayList<Offer> localOffers = new ArrayList<>(Arrays.asList(myOffers));
        localOffers.removeIf(p -> !p.location.equals("VA") && !p.location.equals("CA")); // removes the offer if the offer is NOT local
